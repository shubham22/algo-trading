# Link to original algorithm: https://app.composer.trade/symphony/WDQzBV4Mse7Zypxk4LtC/details
...
def get_recommendations(date, dollar_amount):
    ...
    start_date = end_date - pd.DateOffset(months=24)  # Adjust as needed for historical data
